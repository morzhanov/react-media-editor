(function (global, factory) {
  ...
  function (_React$Component) {
    ...
    function AddCommentPopup() {
      ...
      _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "field", React.createRef());
  ...
  function (_React$Component) {
    ...
    _createClass(AudioEditor, [{
      ...
      value: function render() {
        ...
        }, React.createElement(AudioChart, _extends({
          progressClickHandler: this.progressClickHandler,
        ...
        })), React.createElement("aside", null, React.createElement(CommentsList, {
  ...
  var MediaEditor = function MediaEditor(_ref) {
    var type = _ref.type,
        media = _ref.media,
        ratio = _ref.ratio,
        src = _ref.src;
    ...
    switch (type) {
      ...
      case TYPE_AUDIO:
        return React.createElement(AudioEditor, {
          src: src
        });
